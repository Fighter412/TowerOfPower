...
COLORSRGBL = [(196,237,255), (51,152,75), (139,172,15), (234,50,60), (191,111,74), (200,145,62), (255,173,99), (255,219,162)]
...
def PROCEDURE_MAINGAME():
    ...
    while True:
        ...
        for item in lava:
            if True:
                corners = [[player_coords[0], player_coords[1]], [player_coords[0]+PLAYERWIDTH, player_coords[1]], [player_coords[0]+PLAYERWIDTH, player_coords[1]+PLAYERHEIGHT], [player_coords[0], player_coords[1]+PLAYERHEIGHT], [player_coords[0]+PLAYERWIDTH/2, player_coords[1]+PLAYERHEIGHT/2]]
        ...
        if keys[pygame.K_a] and keys[pygame.K_d] and lr_movement[0] and alive:
            ...
            idlewalk[0] = "IDLE_F"
        if keys[pygame.K_s] and not alternative and access_level >= 3 and reload[0] == 0 and reload[1] == 0 and reload[2] == 0:
            if dag_L:
                ...
                attack_color[0] = True
            reload[0] = 200
        if keys[pygame.K_q] and not alternative and access_level == 4 and reload[0] == 0 and reload[1] == 0 and reload[2] == 0:
            alternative = ["180_L_D", 0, 6*6]
            attack_color[1] = not attack_color[1]
            reload[1] = 200
        if keys[pygame.K_e] and not alternative and access_level == 4 and reload[0] == 0 and reload[1] == 0 and reload[2] == 0:
            alternative = ["180_R_D", 0, 6*6]
            attack_color[1] = not attack_color[1]
            reload[1] = 200
        if keys[pygame.K_z] and not alternative and access_level == 4 and reload[0] == 0 and reload[1] == 0 and reload[2] == 0:
            alternative = ["540_L", 0, 10*6]
            attack_color[1] = not attack_color[1]
            reload[2] = 200
        if keys[pygame.K_c] and not alternative and access_level == 4 and reload[0] == 0 and reload[1] == 0 and reload[2] == 0:
        ...
        pygame.draw.rect(SCREEN, RED, pygame.Rect(player_coords[0], player_coords[1]+offset, PLAYERWIDTH, PLAYERHEIGHT))
        if not alternative:
            ...
            alternative[1] = (alternative[1]+1)%48
        ...
        pygame.draw.polygon(SCREEN, RED, [(1570, 35), (1570+HP/5, 35), (1584+HP/5, 55), (1584, 55)])
